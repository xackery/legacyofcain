...
int NPC::GetItemProperty(int aug_index, int rarity, int slot_type, int class_type, int item_level) {
	...
	static Item_Property items[] = {
		...
		Item_Property(7201,1,4, 1, 164),
		Item_Property(7202,15,4, 1, 150),
		Item_Property(7203,30,4, 1, 135),
		Item_Property(7204,40,4, 1, 125),
		Item_Property(7205,50,4, 1, 115),
		Item_Property(7206,60,4, 1, 105),
		Item_Property(7207,70,4, 1, 95),
		Item_Property(7208,80,4, 1, 85),
		Item_Property(7209,90,4, 1, 75),
		Item_Property(7210,100,4, 1, 65),
