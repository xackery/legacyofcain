...
RULE_INT(NPC, NormalCategoryChanceNormal, 1)
RULE_INT(NPC, NormalCategoryChanceNightmare, 1)
RULE_INT(NPC, NormalCategoryChanceHell, 1)
RULE_INT(NPC, ChampionCategoryChanceNormal, 1)
RULE_INT(NPC, ChampionCategoryChanceNightmare, 1)
RULE_INT(NPC, ChampionCategoryChanceHell, 1)
RULE_INT(NPC, RareCategoryChanceNormal, 1)
RULE_INT(NPC, RareCategoryChanceNightmare, 1)
RULE_INT(NPC, RareCategoryChanceHell, 1)
RULE_INT(NPC, UniqueCategoryChanceNormal, 1)
RULE_INT(NPC, UniqueCategoryChanceNightmare, 1)
RULE_INT(NPC, UniqueCategoryChanceHell, 1)
RULE_INT(NPC, SuperUniqueCategoryChanceNormal, 1)
RULE_INT(NPC, SuperUniqueCategoryChanceNightmare, 1)
RULE_INT(NPC, SuperUniqueCategoryChanceHell, 1)
RULE_INT(NPC, BossCategoryChanceNormal, 1)
RULE_INT(NPC, BossCategoryChanceNightmare, 1)
RULE_INT(NPC, BossCategoryChanceHell, 1)
RULE_INT(NPC, ItemDrop0ChanceNormal, 1)
RULE_INT(NPC, ItemDrop0ChanceNightmare, 1)
RULE_INT(NPC, ItemDrop0ChanceHell, 1)
RULE_INT(NPC, ItemDrop1ChanceNormal, 1)
RULE_INT(NPC, ItemDrop1ChanceNightmare, 1)
RULE_INT(NPC, ItemDrop1ChanceHell, 1)
RULE_INT(NPC, ItemDrop2ChanceNormal, 1)
RULE_INT(NPC, ItemDrop2ChanceNightmare, 1)
RULE_INT(NPC, ItemDrop2ChanceHell, 1)
RULE_INT(NPC, ItemDrop3ChanceNormal, 1)
RULE_INT(NPC, ItemDrop3ChanceNightmare, 1)
RULE_INT(NPC, ItemDrop3ChanceHell, 1)
RULE_INT(NPC, ItemDrop4ChanceNormal, 1)
RULE_INT(NPC, ItemDrop4ChanceNightmare, 1)
RULE_INT(NPC, ItemDrop4ChanceHell, 1)
RULE_INT(NPC, ItemDrop5ChanceNormal, 1)
RULE_INT(NPC, ItemDrop5ChanceNightmare, 1)
RULE_INT(NPC, ItemDrop5ChanceHell, 1)
RULE_INT(NPC, ItemDrop6ChanceNormal, 1)
RULE_INT(NPC, ItemDrop6ChanceNightmare, 1)
RULE_INT(NPC, ItemDrop6ChanceHell, 1)
RULE_INT(NPC, ItemCommonChanceNormal, 1)
RULE_INT(NPC, ItemCommonChanceNightmare, 1)
RULE_INT(NPC, ItemCommonChanceHell, 1)
RULE_INT(NPC, ItemUncommonChanceNormal, 1)
RULE_INT(NPC, ItemUncommonChanceNightmare, 1)
RULE_INT(NPC, ItemUncommonChanceHell, 1)
RULE_INT(NPC, ItemRareChanceNormal, 1)
RULE_INT(NPC, ItemRareChanceNightmare, 1)
RULE_INT(NPC, ItemRareChanceHell, 1)
RULE_INT(NPC, ItemLegendaryChanceNormal, 1)
RULE_INT(NPC, ItemLegendaryChanceNightmare, 1)
RULE_INT(NPC, ItemLegendaryChanceHell, 1)
RULE_INT(NPC, ItemUniqueChanceNormal, 1)
RULE_INT(NPC, ItemUniqueChanceNightmare, 1)
RULE_INT(NPC, ItemUniqueChanceHell, 1)
RULE_CATEGORY_END()
